    ...
    <>
      ...
      <div className=" hero flex border items-center flex-col h-[93.5vh] bg-base-300 pt-8 bg-black">
        ...
        <div
         ...
         bg-opacity-50  bg-gray-600 backdrop-blur-lg pl-4 pr-4"
        >
          <div className="w-full flex px-4 text-xl font-bold text-white">
            <div className="w-2/5">PROBLEM ID</div>
            <div className="w-2/5">PROBLEM NAME</div>
          ...
          {myList.map((problem, index) => (
            <div className="w-full flex px-4" key={index}>
              {index % 2 == 1 ? (
                <div className=" py-2 w-full flex h-full rounded-xl">
                  <div className="w-full text-white hover:link font-semibold">
                    {problem.name.id}
                  </div>
                  <div className="w-full pl-2 flex">
                    <div className="max-w-max">
                      <Link
                        ...
                        className="w-full"
                      >
                        <div className="w-full text-white hover:link hover:text-blue-600 font-semibold capitalize">
                          {problem.name.name}
                        </div>
                      </Link>
                    </div>
