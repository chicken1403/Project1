...
const Navbar = ({ pagination }) => {
  ...
  return (
    <div className="navbar bg-black h-fit max-h-3 w-screen px-10 z-99">
      {/* <div className="flex-1">
            <a className="btn btn-ghost text-xl">daisyUI</a>
            </div> */}
      <div className="flex-1 w-fit text-left ">
        <Link to="/">
          <div className="h-full bg-black p-1 rounded-lg">
            {/* <img
            ...
            /> */}
            <h1 class="text-3xl font-bold text-gray-600">ELITE CODE</h1>
          </div>
        </Link>
      </div>
      ...
      {pagination && (
        <div className="flex items-center gap-2 flex-1 justify-center">
          <div
            className="flex items-center justify-center rounded bg-gray-700 text-white h-8 w-8"
      ...
      <div className="flex ">
        ...
        {!user && (
          <div className="flex align-middle items-center justify-center w-fit">
            ...
            <button
              className="bg-gray-700 text-white p-1.5 px-3 rounded font-semibold text-sm hover:bg-[#72FFFF] hover:text-blue-800 transition ease-in-out duration-300"
